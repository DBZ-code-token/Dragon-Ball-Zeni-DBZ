/**
 ...
 |  __ \|  _ \___  /                    | | | |                                  
 | |  | | |_) | / /    ___  _ __     ___| |_| |__   ___ _ __ ___ _   _ _ __ ___  
 | |  | |  _ < / /    / _ \| '_ \   / _ \ __| '_ \ / _ \ '__/ _ \ | | | '_ ` _ \ 
 | |__| | |_) / /__  | (_) | | | | |  __/ |_| | | |  __/ | |  __/ |_| | | | | | |
 |_____/|____/_____|  \___/|_| |_|  \___|\__|_| |_|\___|_|  \___|\__,_|_| |_| |_|
 In memory of the beloved Akira Toyirama (1955-2024)
 DRAGON BALL ZENI ($DBZ)
 Tribute token to Dragon Ball Sagas and Akira Toriyama
...
/*
#DBZ #DragonBallZeni #ETHEREUM #ERC20
*/
...
contract DragonBallZeni is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 59000000 * 10**_decimals;
    string private constant _name = unicode"Dragon Ball Zeni"; 
    string private constant _symbol = unicode"DBZ";
    uint256 public _maxTxAmount =   1180000 * 10**_decimals;
    uint256 public _maxWalletSize = 1180000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 1180000 * 10**_decimals;
    uint256 public _maxTaxSwap= 1180000 * 10**_decimals;
